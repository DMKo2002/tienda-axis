...
export default function CatalogFilters({
  ...
  return (
    <div className="space-y-7 sticky top-28">
      ...
      {/* Buscador */}
      <div>
        <p className="text-[10px] tracking-[0.2em] uppercase text-[var(--color-stone)] mb-3">Buscar</p>
        <form onSubmit={handleSearch} className="relative">
          <input
            type="text"
            value={q}
            onChange={e => setQ(e.target.value)}
            placeholder="Remera, vestido..."
      ...
      <div>
        ...
        <form onSubmit={handlePrecio} className="space-y-2">
